        ...
        <div className='pb-10'>
            ...
            >
                <div className='w-[50vw] z-10 text-center'>
                    ...
                    <p className='z-10 text-white-300 text-xl lg:text-4xl'>Taste the Convenience : Food , Fast and Delivered </p>
                </div>
            ...
            <section className='px-5 lg:px-20 pt-10'>
                 <h1 className='text-2xl font-semibold text-gray-400 pb-10'>Order From Our Handpicked Favorites</h1>
